...
import com.dhc.pos.util.TrafficUtil;
...
public class ApplicationEnvironment {
	...
	private void initFiles(){
		// 如果是第一次启动系统，首先需要初始化，将assets下所有的文件复制到/data/data/com.dhc.pos/assets下。
...
//		if (0 == currentVersion) {
	...
	***/
	...
	private void cleanUp() {
		...
		// 关闭FSKService
		this.getApplication().stopService(new Intent("com.dhc.pos.fskService"));
		
		// 停止超时服务
		this.getApplication().stopService(new Intent("com.dhc.pos.timeoutService"));
		
		this.getApplication().stopService(new Intent("com.dhc.pos.uploadSignImageService"));
