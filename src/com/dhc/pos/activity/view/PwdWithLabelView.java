...
public class PwdWithLabelView extends LinearLayout implements TextWatcher, OnFocusChangeListener, OnTouchListener {
	...
	public PwdWithLabelView(Context context) {
		super(context);
		
		init(context);
	}

	public PwdWithLabelView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void init(Context context){
		...
		inflater.inflate(R.layout.pwd_with_label, this);
	...
	public void setHintWithLabel(String hint){
		editText.setHint(hint);
	}
