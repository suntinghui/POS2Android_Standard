...
public class ClassLoaderUtil {
	...
	public static URL getExtendResource(String relativePath)
		...
		// ClassLoaderUtil.System.out.println(Integer.valueOf(relativePath.indexOf("../")))
		// ;
		if (!relativePath.contains("../")) {
	...
	public static String getExtendResource2(String relativePath)
			throws MalformedURLException {
		if (!relativePath.startsWith(".")) {
			...
			post = relativePath.lastIndexOf(".");
			suffix = relativePath.substring(post);
			relativePath = relativePath.substring(0, post);
//			System.out.println("relativePath 00" +relativePath );
...
//			relativePath = relativePath.replaceAll("\\u002E", "/");
			 relativePath= relativePath.replaceAll("\\u002E",System.getProperty("java.class.path"));
			
//			 System.out.println("System.getProperty('java.class.path')" + System.getProperty("java.class.path"));
//			 System.out.println("relativePath 0" +relativePath );
			 relativePath = path + relativePath + suffix;
//			System.out.println("relativePath 1:{}" +relativePath );
		} else {
			relativePath = getExtendResource(relativePath).getPath();
//			System.out.println("relativePath 2:{}" +relativePath );
		}
		return relativePath;
	}
	 ...
	 * @throwsMalformedURLException
	 */
	public static URL getExtendResourceLinux0(String relativePath)
			throws MalformedURLException {
	...
	public static String getExtendResourceLinux(String relativePath)
			throws MalformedURLException {
		if (!relativePath.startsWith(".")) {
			int post = relativePath.lastIndexOf(".");
			String suffix = relativePath.substring(post);
			relativePath = relativePath.substring(0, post);
			...
			relativePath = getExtendResourceLinux0(relativePath).getPath();
		}
		return relativePath;
	}
	...
	public static void main(String[] args) throws MalformedURLException,
		...
		System.out
				.println((ClassLoaderUtil.getExtendResource("msgConfig.xml")));

		// System.out.println(ClassLoaderUtil.getClassLoader().getResource("jdbc.properties").toString());
