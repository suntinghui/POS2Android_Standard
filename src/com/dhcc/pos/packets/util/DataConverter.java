...
public class DataConverter {
	 ...
	 */
	/*
	 * public static String BCD2ASC(byte[] bytes) { StringBuffer temp = new
	 * StringBuffer(bytes.length * 2);
	 * 
	 * for (int i = 0; i < bytes.length; i++) { int h = ((bytes[i] & 0xf0) >>>
	 * 4); int l = (bytes[i] & 0x0f); temp.append(BToA[h]).append( BToA[l]); }
